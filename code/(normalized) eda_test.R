...
folder_paths <- c("final_jpeg_data/test/drawings", "final_jpeg_data/test/engraving", "final_jpeg_data/test/iconography", "final_jpeg_data/test/sculpture")
shape_features <- data.frame()
...
# 匯出正規化後的數據到CSV文件
write.csv(normalized_features, "(test) shape_features_normalized.csv", row.names = FALSE)
